...
{{< note >}}
An audit [Event](/docs/reference/config-api/apiserver-audit.v1/#audit-k8s-io-v1-Event)
...
You can also refer to the [`Policy` reference](/docs/reference/config-api/apiserver-audit.v1/#audit-k8s-io-v1-Policy)
